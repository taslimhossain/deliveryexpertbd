...
const Ridercost = () => {
  ...
  const { data, loading } = useAsync(RidercostServices.getAllItems);
  const {
    handleSubmitCoupon,
    couponRef,
    dataTable,
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell>Sallery amount</TableCell>
                <TableCell>Rider type</TableCell>
                <TableCell>Status</TableCell>
                <TableCell className="text-right">Actions</TableCell>
              </tr>
            </TableHeader>
            <RidercostTable ridercosts={dataTable} />
          </Table>
          <TableFooter>
            <Pagination
